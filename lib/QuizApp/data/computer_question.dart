...
List<QuizQuestion> computerQuestions = [
  ...
  QuizQuestion(
    ...
    options: ["Google", "Intel", "Windows", "Office"],
    answerIndex: 2,
  ),
  QuizQuestion(
    id: 3,
    question: "What is the main storage device in a computer?",
    options: ["RAM", "Monitor", "Hard Drive", "Keyboard"],
    answerIndex: 2,
  ),
  QuizQuestion(
    id: 4,
  ...
  QuizQuestion(
    ...
    options: ["Swift", "Kotlin", "Python", "PHP"],
    answerIndex: 1,
  ),
  QuizQuestion(
    id: 7,
  ...
  QuizQuestion(
    ...
    options: ["World Wide Web", "World Whole Web", "Web World Wide", "World Wide Waves"],
    answerIndex: 0,
  ),
  QuizQuestion(
    id: 10,
